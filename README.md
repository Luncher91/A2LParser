...
## Command Line Sample (A2L to JSON)
```console
java -jar A2LParser-1.1.0-jar-with-dependencies.jar src/test/resources/freeTest.a2l
```
...
## Command Line Sample (JSON Schema)

```console
java -jar A2LParser-1.1.0-jar-with-dependencies.jar --schema
```
