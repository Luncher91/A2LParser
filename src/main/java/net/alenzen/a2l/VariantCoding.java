...
public class VariantCoding extends A2LSerializer implements IA2LWriteable, IAsap2TreeElement {
	...
	public List<IAsap2TreeElement> collectSubNodes() {
		...
		Asap2FileIterator.addIfNotNull(subNodes, this.varCharacteristics);
		Asap2FileIterator.addIfNotNull(subNodes, this.varCriterion);
		Asap2FileIterator.addIfNotNull(subNodes, this.varForbiddenComb);
		return subNodes;
	}
}
